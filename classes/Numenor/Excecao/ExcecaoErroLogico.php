 ...
 * Erros lógicos são normalmente causados por algum valor ou ação incorretos definidos pelo usuário do
 * sistema, e o sistema deve poder se recuperar deles de maneira amigável (informando o usuário do erro
 * erro ocorrido de maneira clara e possibilitando que ele refaça a ação ou informe novamente o valor
