...
class Checksum
{
	 ...
	 * @access public
	 * @static
	 * @param string $chave Chave definida para utilização na geração dos checksums. Note que é possível alterar a chave
	 * uma vez definida (para permitir que chaves diferentes sejam utilizadas na geração  de checksums diferentes), mas 
	 * não é possível definir uma chave vazia.
