 ...
 * tipo inválido como chave de um array (ou seja, não é um inteiro, nem uma string, nem um objeto que implementa o método
 * __toString()).
 *
...
class ExcecaoChaveInvalida extends \Numenor\Excecao\ExcecaoErroUso {
	...
	public function __construct(\Exception $previous = null) {
		parent::__construct('O método invocado requer que o parâmetro $chave seja de um tipo válido: {String}, {Integer}, ou um objeto representável como uma string.', 
				self::CODE_ARRAYWRAPPER_CHAVETIPOINVALIDO, $previous);
	}
}